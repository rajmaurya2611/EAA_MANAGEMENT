...
import FirstYearPYQ from '../../components/PYQs/FirstYearPYQ';
import SecondYearPYQ from '../../components/PYQs/SecondYearPYQ';
import ThirdYearPYQ from '../../components/PYQs/ThirdYearPYQ';
import FourthYearPYQ from '../../components/PYQs/FourthYearPYQ';
  ...
  return (
    <Layout style={{ minHeight: '100vh' }}>
      <Content style={{ margin: '16px', padding: '20px', background: '#fff', borderRadius: '8px' }}>
        ...
        {activeTab === 'first' && <FirstYearPYQ />}
        {activeTab === 'second' && <SecondYearPYQ/>}
        {activeTab === 'third' && <ThirdYearPYQ />}
        {activeTab === 'fourth' && <FourthYearPYQ/>}
      </Content>
    </Layout>
  );
};
